 ...
 */
export const Serif = (props: SerifV1Props) => {
...
const transformSerifPropsToV3 = (props: SerifV1Props): TextProps => {
  const { size, weight, ...newProps } = clone(props)

  const actualSize = isArray(size) ? size[0] : size
 ...
 */
export const Sans = (props: SansV1Props) => {
